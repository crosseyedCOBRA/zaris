...
// Marquee-scrolling text for content that doesn't fit its allotted width
// (adapted from Widgets/NScrollText.qml, MIT licensed, v4.7.7 - see
// README.md's "Third-party code" section). No color/settings coupling in
// the original - ported unmodified aside from dropping the module import.
Item {
    id: root
    ...
    Rectangle {
        ...
        gradient: Gradient {
            ...
            GradientStop { position: fadeExtent; color: "white" }
            GradientStop { position: 1 - fadeExtent; color: "white" }
