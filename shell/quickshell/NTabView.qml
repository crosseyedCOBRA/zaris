...
// Slide-transition container for tab content, paired with NTabBar/
// NTabButton (adapted from Widgets/NTabView.qml, MIT licensed, v4.7.7 - see
...
Item {
    ...
    Component.onCompleted: _initializeItems()
